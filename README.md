...
| ---------- | ------------------------------------------------------------------------------ | -------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Cloud**  | AWS services for building, deploying & securing scalable systems               | AWS                                                                  | - [Securing VPC](https://github.com/nikiimisal/3-tier_Architecture_Related/blob/main/VPC.md) <br><br> - [Project – Movie Ticket Booking System (AWS 3-Tier Architecture)](https://github.com/nikiimisal/Project--Movie-Ticket-Booking-System-AWS-3-Tier-Architecture-/blob/main/Movie%20Ticket%20Booking%20System%20%28AWS%203-Tier%20Architecture%29.md) <br><br> - [Project – Mark Your Attendance (AWS SDK 3-Tier Architecture)](https://github.com/nikiimisal/Project-Mark-Your-Attendance-3-Tier-AWS-SDK-Architecture/blob/main/README.md) <br><br> - [Project – Serverless Application (Sacred Temple File Uploader using Lambda)](https://github.com/nikiimisal/project--Serverless-application--Sacred-Temple-File-Uploader--using-lambda) |
| **DevOps** | Using DevOps tools to understand complete workflows & practical implementation | Docker, Kubernetes, Jenkins, Terraform, Ansible, Prometheus, Grafana | - CI/CD Pipeline Implementation <br><br> - Docker Containerization Projects <br><br> - Kubernetes YAML Deployments <br><br> - Infrastructure as Code (Terraform) <br><br> - Monitoring Setup (Prometheus & Grafana)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **SCM**    | Version control & repository management                                        | GitHub, GitLab, CodeCommit                                           | - [Git & GitHub Setup](https://github.com/nikiimisal/Git-Github/tree/main) <br><br> - [GitLab Profile](https://gitlab.com/nikiimisal) <br><br> - AWS CodeCommit                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
